...
*/
    ...
    * @returns {HTMLDivElement} html div container with 3 buttons and a time stamp
    ...
    buildCard() {
        ...
        div.appendChild(this.createButton("Insert Before", "btn btn-before", this.insertBefore));
        div.appendChild(this.createButton("Insert After", "btn btn-after", this.insertAfter));
    ...
    * @param {event} event -- Event
    ...
    insertAfter(event) {
        ...
        let p = document.createElement("p");
        p.appendChild(document.createTextNode(d.toLocaleTimeString()))
        parentNode.parentNode.insertBefore(card.buildCard(p), parentNode.nextSibling);
    }
