...
# # runs test on test with words add or string
# pytest test_temp.py - v - k "add or string"
# # runs tests with words add and string
# pytest test_temp.py - v - k "add and string"
