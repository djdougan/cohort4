...
test("Test: add(num1, num2) returns number", () => {
    ...
    expect(calculator.add(200, "A2")).toBe("Error: Both number1 and number2 must be numbers");
...
test("Test: subtract(num1, num2) returns number", () => {
    ...
    expect(calculator.subtract(200, "A2")).toBe("Error: Both number1 and number2 must be numbers");
...
test("Test: multiply(num1, num2) returns number", () => {
    ...
    expect(calculator.multiply(200, "A2")).toBe("Error: Both number1 and number2 must be numbers");
...
test("Test: divide(num1, num2) returns number", () => {
    ...
    expect(calculator.divide(200, 0)).toBe("Error: Divide by 0, the divisor cannot be 0.");
    expect(calculator.divide(200, "A2")).toBe("Error: Both dividend and divisor must be numbers");
});